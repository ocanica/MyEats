...
namespace MyEats.Commons.Constants
{
    public class PostcodeDictionary
    {
        public static Dictionary<string, string> Postcodes = new Dictionary<string, string>
        {
            {"E1", "Whitechapel Stepney, Mile End" },
            {"E1W", "Wapping" },
            {"E2", "Bethnal Green, Shoreditch" },
            {"E3", "Bow, Browley-By-Bow" },
            ...
            {"SE1", "Waterloo, Bermondsey, Southwar, Borough" },
            {"SE2", "Abbey Wood" },
